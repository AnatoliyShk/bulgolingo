            ...
            <div class="mx-auto max-w-2xl px-4 sm:px-6 lg:px-8">
                <section class="rounded-lg border border-gray-200 bg-white p-6 shadow dark:border-gray-700 dark:bg-gray-800">
                    ...
                    <form @submit.prevent="submit" class="space-y-5">
                        ...
                        <!-- Dialogue -->
                        <div>
                            <label for="scripted_dialogue_id" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Dialogue</label>
                            <select
                                id="scripted_dialogue_id"
                        ...
                        <!-- Line text -->
                        <div>
                            <label for="line_text" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Line text</label>
                            <input
                                id="line_text"
