...
const props = defineProps({
    ...
    // Someone else's profile: the identity block stays, everything that belongs
    // to the account rather than to the person is left off.
    isPublic: {
        type: Boolean,
        default: false,
    },
        ...
        <main class="nb-prof__main">
            ...
            <section class="nb-prof__hero">
                ...
                <div class="nb-prof__info nb-prof__info--card">
                    ...
                    <p v-if="user.email" class="nb-prof__email">{{ user.email }}</p>
                    <p v-if="memberSince" class="nb-prof__member">Learning Bulgarian since {{ memberSince }}</p>
                </div>
                <Link v-if="!isPublic" :href="route('profile.edit')" class="nb-prof__edit-btn" aria-label="Edit profile">
            ...
            <!-- Learning paths -->
            <section v-if="!isPublic" class="nb-prof__section">
            ...
            <!-- Stats link -->
            <Link v-if="!isPublic" :href="route('stats.show')" class="nb-prof__stats">
