...
const DEFAULT_FILTERS: Filters = { level: 'A2', sort: 'exercises_desc' };
...
const FIRST_LOAD: Props = {
    ...
    levels: [{ value: 'A1', label: 'A1 Beginner' }, { value: 'A2', label: 'A2 Elementary' }],
        ...
        await route.fulfill({
            ...
            body: JSON.stringify({
                ...
                props: {
                    ...
                    filters: { level: url.searchParams.get('level') ?? 'A2', sort },
                },
            }),
        });
    });
